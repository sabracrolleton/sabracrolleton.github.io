#+TITLE: Quicklisp Projects with Short Descriptions From Their ASD files (10 Oct 2022 Edition)
...
|-------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [[https://github.com/lmj/1am][1am]]  | A minimal testing framework. (MIT)|
| [[https://github.com/3b/3b-bmfont][3b-bmfont]] | BMFont file format readers/writers (MIT) |
| [[https://github.com/3b/3bgl-shader][3bgl-shader]] | CL-hosted CL-like DSL for generating GLSL (MIT) |
| [[https://github.com/3b/3b-hdr][3b-hdr]] | reader and writer for radiance HDR files (MIT) |
| [[https://github.com/3b/3bmd][3bmd]] | markdown processor in CL using esrap parser. (MIT) |
...
| [[https://github.com/3b/3bmd][3bmd-ext-definition-lists]] | extension to 3bmd implementing 'PHP Markdown Extra' style definition lists (MIT) |
| [[https://github.com/3b/3bmd][3bmd-ext-math]] | An extension for 3bmd for handling math markup (MIT) |
| [[https://github.com/3b/3bmd][3bmd-ext-tables]] | Extension to 3bmd implementing PHP Markdown Extra style tables (MIT) |
| [[https://github.com/3b/3bmd][3bmd-ext-wiki-links]] | example extension to 3bmd implementing simple wiki-style links (MIT) |
...
| [[https://github.com/Shinmera/3d-matrices][3d-matrices]] | A utility library implementing 2x2, 3x3, 4x4, and NxN matrix functionality. (zlib) |
...
| [[https://github.com/Shinmera/3d-vectors][3d-vectors]] | A utility library implementing 2D, 3D, and 4D vector functionality. (zlib) |
...
| [[https://github.com/dherring/able][able]] | A Common Lisp editor (MIT) |
| [[https://github.com/dimitri/cl-abnf][abnf]] | ABNF Parser Generator, per RFC2234 (ISC license) |
...
| [[https://github.com/sharplispers/access][access]] | A library providing functions that unify data-structure access for Common Lisp:access and (setf access). (BSD 2 clause)Comments by 40ants [[https://github.com/40ants/lisp-project-of-the-day/blob/master/content/2020/03/0007-access.org][here]]. |
| [[https://github.com/robert-strandh/Acclimation][acclimation]] | Library supporting internationalization (FreeBSD) |
| [[https://github.com/rpav/cl-cairo2][a-cl-cairo2-loader]] | Cairo bindings for common lisp (Boost Software License 1.0) |
| [[https://github.com/AccelerationNet/a-cl-logger][a-cl-logger]] | A logger that sends to multiple destinations in multiple formats. Based on arnesi logger (BSD 3 clause) |
| [[https://github.com/AccelerationNet/a-cl-logger][a-cl-logger-logstash]] | Load the logstash appender for a-cl-logger (BSD) |
...
| [[https://hg.stevelosh.com/adopt][adopt]] | Simple, flexible, UNIX-style option parsing. (MIT) |
| [[https://gitlab.com/daewok/adopt-subcommands][adopt-subcommands]] | Extend the Adopt command line processing library to handle nested subcommands. (MIT) |
| [[https://github.com/Kalimehtar/advanced-readtable][advanced-readtable]] | Advanced customizable readtable (BSD 2 Clause)|
| [[https://common-lisp.net/project/adw-charting/adw-charting.tar.gz][adw-charting]] | Charting package to make pretty graphs and charts - Removed in Oct 2021 Quicklisp Update (LGPL) |
...
| [[https://github.com/dtqec/aether][aether]] | A DSL for emulating an actor-based distributed system, housed on a family of emulated devices. (MIT) |
| [[https://gitlab.common-lisp.net/mraskin/agnostic-lizard][agnostic-lizard]] | A portable code walker that makes a best effort to be correct in most cases (GPL 3) |
| [[https://gitlab.common-lisp.net/mraskin/agnostic-lizard][agnostic-lizard-debugger-prototype]] | A portable debugger prototype that injects debugger hooks into code (GPL 3) |
| [[https://github.com/alex-gutev/agutil][agutil]] | A collection of utility functions not found in other utility libraries. (MIT) |
| [[https://github.com/ahungry/ahungry-fleece][ahungry-fleece]] | A general utility library of convenience functions and features. (GPL 3) |
| [[https://github.com/rigetti/alexa][alexa]] | A lexical analyzer generator.(BSD 3) |
| [[https://gitlab.common-lisp.net/alexandria/alexandria][alexandria]] | Alexandria is a collection of portable public domain utilities. (Public Domain) |
| [[https://github.com/Symbolics/alexandria-plus/][alexandria-plus]] | A conservative set of extensions to Alexandria utilities  (Public Domain) |
| [[https://github.com/tarballs-are-good/algebraic-data-library][algebraic-data-library]] | A library of common algebraic data types. (BSD 3) |
| [[https://github.com/varjagg/also-alsa][also-alsa]] | Basic ALSA bindings for Common Lisp (LGPL) |
| [[https://github.com/gonzojive/amazon-ecs][amazon-ecs]] | Amazon Product Advertising API library for Common Lisp (LLGPL) |
| [[https://github.com/phoe/amb/][amb]] | An implementation of John McCarthy's ambiguous operator(MIT)|
| [[https://github.com/spwhitton/anaphora][anaphora]] | The Anaphoric Macro Package from Hell (Public Domain) |
...
| [[https://gitlab.common-lisp.net/antik/antik][antik]] | A library of numerical mathematics. (GPL 3) |
| antik-base | Basic definitions providing a foundation for computational mathematics, science, and engineering. (GPL 3) |
| [[https://github.com/fukamachi/anypool][anypool]] | General-purpose pooling library (BSD 2 clause) |
| [[https://github.com/pve1/apply-argv][apply-argv]] | Apply-argv is a library for parsing command line arguments. (LLGPL) |
| [[https://github.com/phantomics/april][april]] | April is a subset of the APL programming language that compiles to Common Lisp. (Apache 2) Comments by 40ants [[https://github.com/40ants/lisp-project-of-the-day/blob/master/content/2020/04/0025-april.org][here]]. |
...
| [[https://github.com/sharplispers/archive][archive]] | A package for reading and writing archive (tar, cpio, etc.) files. (BSD 2 Clause) Comments by 40ants [[https://github.com/40ants/lisp-project-of-the-day/blob/master/content/2020/03/0019-archive.org][here]]. |
| [[https://github.com/K1D77A/arithmetic-operators-as-words][arithmetic-operators-as-words]] | Just simple macros that expand to the normal arithmetic operators.(MIT)                                 |
| [[https://github.com/AccelerationNet/arnesi][arnesi]] | A bag-of-tools utilities library used to aid in implementing the bese.it toolkit (MIT) |
...
| [[https://github.com/hipeta/arrow-macros][arrow-macros]] | arrow-macros provides clojure-like arrow macros and diamond wands. (MIT) |
...
| [[https://bitbucket.org/vityok/cl-string-match][ascii-strings]] | Operations on ASCII strings. Essentially this can be any kind ofsingle-byte encoded strings.(BSD 3 Clause) |
...
| [[https://github.com/eudoxia0/asdf-linguist][asdf-linguist]] | Extensions for ASDF. (MIT) Comments by 40ants [[https://github.com/40ants/lisp-project-of-the-day/blob/master/content/2020/04/0038-asdf-linguist.org][here]]. |
...
| [[https://github.com/phoe/asd-generator][asd-generator]] | Automatic directory scanner/generator for .asd project files. (GPL 3) |
|[[https://github.com/fukamachi/asn1/][asn1]] | ASN.1 encoder/decoder — BSD 2-Clause |
| [[https://github.com/noloop/assertion-error][assertion-error]] | Error pattern for assertion libraries in Common Lisp. (GPL 3) |
| [[https://github.com/noloop/assert-p][assert-p]] | A library of assertions written in Common Lisp. (GPL 3) |
...
| [[https://github.com/tdrhq/auto-restart/][auto-restart]] | automatically generate restart-cases for the most common use cases, and also use the restart for automatic retries (Apache 2.0) |
...
| [[https://github.com/phoe/binding-arrows][binding-arrows]] | An implementation of threading macros based on binding anonymous variables (MIT) |
...
| [[https://github.com/marcoheisig/bitfield/][bitfield]] | Efficiently represent several finite sets or small integers as a single non-negative integer. (MIT)|
...
| [[https://github.com/hyotang666/bnf][bnf]] | BNF example generator. Useful for testing parser. (MIT) |
...
| [[https://github.com/borodust/bodge-concurrency][bodge-concurrency]] | Concurrency utilities (MIT) |
...
| [[https://github.com/borodust/bodge-heap][bodge-heap]] | Heap implementation (MIT)|
| [[https://github.com/borodust/bodge-host][bodge-host]] | OS-dependent routines (MIT) |
| [[https://github.com/borodust/bodge-libc-essentials][bodge-libc-essentials]] | Common Lisp bindings to most essential part of libc (MIT) |
| [[https://github.com/borodust/bodge-math][bodge-math]] | Math routines (MIT) |
| [[https://github.com/borodust/bodge-memory][bodge-memory]] | Memory handling utilities (MIT) |
| [[https://github.com/borodust/bodge-nanovg][bodge-nanovg]] | Wrapper over nanovg library for cl-bodge system (MIT) |
...
| [[https://github.com/borodust/bodge-queue][bodge-queue]] | Simple FIFO implementation with no external dependencies (MIT) |
| [[https://github.com/borodust/bodge-sndfile][bodge-sndfile]] | Wrapper over libsndfile for cl-bodge system |
| [[https://github.com/borodust/bodge-utilities][bodge-utilities]] | Utility library (MIT) |
...
| [[https://github.com/borodust/c2ffi-blob][c2ffi-blob]] | c2ffi executables for various platforms (MIT) |
...
| [[https://github.com/borodust/cffi-c-ref][cffi-c-ref]] | Adds streamlined access to foreign memory (MIT) |
...
| [[https://github.com/hyotang666/check-bnf][check-bnf]] | Macro arguments checker. (MIT) |
...
| [[https://github.com/FdelMazo/cl-aristid][cl-aristid]] |  Draw Lindenmayer Systems with Common LISP! (MIT) |
...
| [[https://tarballs.hexstreamsoft.com/libraries/latest/class-options_latest.tar.gz][class-options]] | Provides easy access to the defining class and its options during initialization or reinitialization of its subcomponents. (Unlicense) |
| [[https://github.com/shinmera/classowary][classowary]] | An implementation of the Cassowary linear constraint solver toolkit |
| [[https://git.code.sf.net/p/clast/code][clast]] | CLAST is a Common Lisp library that can produce an and abstract syntax tree. Its main use if for source analysis and transformation - extracting the free variables list from a form. (BSD) |
| [[https://github.com/orthecreedence/cl-async][cl-async]] | Base system for cl-async. |
| [[https://github.com/j3pic/cl-async-await][cl-async-await]] | An implementation of async/await for Common Lisp (AGPL3) |
...
| [[https://github.com/Lautaro-Garcia/cl-aubio][cl-aubio]] | Aubio bindings for Common Lisp (CPL3) |
...
| [[https://github.com/borodust/claw-support][claw-support]] | Support routines for claw (MIT) |
| [[https://github.com/borodust/claw-utils][claw-utils]] | Utilities for easier autowrapping (MIT) |
...
| [[https://github.com/tpine/cl-base16][cl-base16]] | Common Lisp implementation of base16 (GPLv2)|
...
| [[https://github.com/tamurashingo/cl-batis][cl-batis]] | SQL Mapping Framework for Common Lisp (MIT) - Removed in Oct 2021 Quicklisp Update|
| [[https://github.com/lhope/cl-bayesnet][cl-bayesnet]] | A Common Lisp Bayesian Network Inference Engine |
| [[https://github.com/dnaeon/cl-bcrypt][cl-bcrypt]] | Common Lisp system for generating and parsing of bcrypt password hashes (BSD 2 clause) |
...
| [[https://github.com/K1D77A/cl-bloggy][cl-bloggy]] | A simple extendable blogging system to use with Hunchentoot (MIT) |
...
| [[https://github.com/dnaeon/cl-covid19][cl-covid19]] | Common Lisp library and utilities for inspecting COVID-19 data (BSD 2) |
...
| [[https://github.com/sirherrbatka/cl-data-structures][cl-data-structures]] | Data structures, ranges, ranges algorithms. (BSD Simplified) |
...
| [[https://gitlab.com/fix9/cl-fix][cl-fix]] | A FIX (Financial Information eXchange) library for Common Lisp (Apache2) |
...
| [[https://gitlab.com/Harag/cl-getx][cl-getx]] | This is a naive, persisted, in memory (lazy loading) data store for Common Lisp. (MIT) |
...
| [[https://github.com/tychoish/cl-grip][cl-grip]] | Grip is a simple logging interface and framework. The  core package contains basic infrastructure and interfaces. (Apache 2) |
...
| [[https://quickdocs.org/cl-heap][cl-heap]]  | An implementation of heap and priority queue data structures. (No longer maintained per [[https://github.com/TheRiver/CL-HEAP][https://github.com/TheRiver/CL-HEAP]])|
...
| [[https://github.com/Frechmatz/cl-html-readme][cl-html-readme]] | A HTML Documentation Generator for Common Lisp projects. (MIT) |
...
| [[https://github.com/yitzchak/cl-indentify][cl-indentify]] | A code beautifier for Common Lisp. (MIT) |
...
| [[https://github.com/compufox/cl-ini/][cl-ini]] INI file parser (MIT)
...
| [[https://github.com/rpav/cl-interval][cl-interval]] | Intervals, interval trees (newBSD LLGPL) |
...
| [[https://github.com/inaimathi/clj][clj]] | Some clojure conveniences for Common Lisp (MIT) |
...
| [[https://github.com/hankhero/cl-json][cl-json]] | JSON in Lisp. JSON is a lightweight data-interchange format. |
...
| [[https://github.com/foretspaisibles/cl-kaputt][cl-kaputt]]| A Simple Interactive Test Framework for Common Lisp (CeCILL-B)|
...
| [[https://github.com/resttime/cl-liballegro][cl-liballegro]] | Allegro 5 game programming library bindings for Common Lisp (MIT) |
| [[https://gitlab.com/lockie/cl-liballegro-nuklear][cl-liballegro-nuklear]] | CFFI wrapper for the Nuklear IM GUI library with liballegro backend, to be used with cl-liballegro. (MIT) |
...
| [[https://github.com/cmoore/cl-mango][cl-mango]] | A minimalist CouchDB 2.x database client. (BSD3) |
...
| [[https://github.com/noloop/cl-minify-css][cl-minify-css]] | To minify css with common lisp. (CPLv3) |
...
| [[https://github.com/inaimathi/cl-notebook/][cl-notebook]] | A notebook-style in-browser editor for Common Lisp  (AGPL3)|
...
| [[https://github.com/djeis97/cl-renderdoc][cl-renderdoc]] | Wrapper around the renderdoc In-Application API for Common Lisp (MIT) |
...
| [[https://github.com/dnaeon/cl-rfc4251][cl-rfc4251]] | Encoding and decoding data in [[https://www.rfc-editor.org/rfc/rfc4251][RFC 4251]] compliant format for ssh (BSD 2 clause) |
...
| [[https://github.com/vindarel/cl-sendgrid][cl-sendgrid]] | Send emails with the SendGrid API (MIT) |
...
| [[https://github.com/zkat/cl-speedy-queue][cl-speedy-queue]] | cl-speedy-queue is a portable, non-consing, optimized queue implementation. (MIT) Comments by 40ants [[https://github.com/40ants/lisp-project-of-the-day/blob/master/content/2020/08/0150-cl-speedy-queue.org][here]]. |
...
| [[https://github.com/dnaeon/cl-ssh-keys][cl-ssh-keys]] | Common Lisp system for generating and parsing of OpenSSH keys (BSD 2 Clause) |
...
| [[https://github.com/pokepay/cl-string-generator][cl-string-generator]] | Generate string from regular expression (MIT) |
...
| [[https://github.com/40ants/cl-telegram-bot][cl-telegram-bot]] | Telegram Bot API, based on sovietspaceship's work but mostly rewritten. (MIT) |
...
| [[https://github.com/tdrhq/cl-unix-sockets/][cl-unix-sockets]] | UNIX Domain socket (Apache License, Version 2.0)   |
...
| [[https://github.com/Frechmatz/cl-wave-file-writer][cl-wave-file-writer]] | A wave file writer (MIT) |
...
| [[https://github.com/inaimathi/cl-zipper][cl-zipper]] | An implementation of functional zippers for Common Lisp (MIT Expat) |
...
| [[https://github.com/ruricolist/cmd][cmd]] | A utility for running external programs (MIT) |
...
| [[https://github.com/Shinmera/colored][colored]] | System for colour representation, conversion, and operation. (zlib) |
...
| [[https://github.com/Shinmera/com-on][com-on]] | Utilities for dealing with COM interfaces. (zlib) |
| [[https://tarballs.hexstreamsoft.com/libraries/latest/compatible-metaclasses_latest.tar.gz][compatible-metaclasses]] | Validates superclasses according to a simple substitution model, thereby greatly simplifying the definition of class mixins. (Unlicense) |
...
| [[https://github.com/hyotang666/core-reader][core-reader]] | Utilities for stream oriented reader. (MIT) |
...
| [[https://github.com/yitzchak/cytoscape-clj][cytoscape-clj]] | A cytoscape widget for Common Lisp Jupyter. (MIT) |
| [[https://github.com/snmsts/daemon][daemon]] | Process daemonization for some common lisp. |
| [[https://github.com/phoe/damn-fast-priority-queue/][damn-fast-priority-queue]] | A heap-based priority queue whose first and foremost priority is speed.  (MIT)|
...
| [[https://github.com/guicho271828/dataloader][dataloader]] | A universal loader library for various data formats for images/audio (LLGPL) |
...
| [[https://github.com/Shinmera/dns-client][dns-client]] | A client for the DNS protocol. (zlib) |
...
| [[https://github.com/s-expressionists/Ecclesia][ecclesia]] | Utilities for parsing Lisp code. (MIT) |
...
| [[https://tarballs.hexstreamsoft.com/libraries/latest/enhanced-find-class_latest.tar.gz][enhanced-find-class]] | Provides a canonical way of converting class designators to classes. (Unlicense) |
...
| [[https://tarballs.hexstreamsoft.com/libraries/latest/enhanced-typep_latest.tar.gz][enhanced-typep]] | Obsoletes all TYPEP thin wrappers. (Unlicense) |
...
| [[https://tarballs.hexstreamsoft.com/libraries/latest/evaled-when_latest.tar.gz][evaled-when]] | Provides a way of extracting and replicating the compile-time side-effects of forms. (Unlicense) |
...
| [[https://github.com/shinmera/feeder][feeder]] | RSS, Atom and general feed parsing and generating (zlib) |
...
| [[https://github.com/Shinmera/file-attributes][file-attributes]] | Access to file attributes (uid, gid, atime, mtime, mod) (zlib) |
...
| [[https://github.com/vindarel/fuzzy-match][fuzzy-match]] | From a string input and a list of candidates, return the most relevant candidates first. (MIT) |
| [[https://github.com/ruricolist/FXML][fxml]] | Bridge HTML5 and FXML |
| [[https://github.com/BnMcGn/gadgets][gadgets]] | Ben McGunigle's utility collection (Apache v. 2) |
...
| [[https://github.com/gpwwjr/GECO][geco]] | GECO is an extensible, object-oriented framework for prototyping genetic algorithms in Common Lisp. (GPL 2.0) |
...
| [[https://github.com/markasoftware/gooptest/][gooptest]] | A microcontroller testing framework. (GPL 3) |
...
| [[https://github.com/grammatech/gtirb-capstone][gtirb-capstone]] | Integration between GTIRB and the Capstone/Keystone libraries (MIT) |
| [[https://github.com/grammatech/gtirb-functions][gtirb-functions]] | Function objects over GTIRB (MIT) |
...
| [[https://github.com/genelkim/gute][gute]] | Gene's personal kitchen sink library. (MIT) |
...
| [[https://github.com/mmontone/hunchentoot-errors][hunchentoot-errors]] | Augments Hunchentoot error pages and logs with request and session information (MIT) |
...
| [[https://github.com/hyotang666/jingoh][jingoh]] | DSL to notate specification, rather than test framework. (MIT) |
...
| [[https://www.thoughtcrime.us/software/jpl-queues/][jpl-queues]]   | A few different kinds of queues, with optional multithreading synchronization. (ISC License) |
...
| [[https://github.com/yitzchak/kekule-clj][kekule-clj]] | A Kekule widget for Common Lisp Jupyter (MIT) |
...
| [[https://github.com/fukamachi/legion][legion]] | Simple worker threads with a queue. (BSD 3 Clause) |
| [[https://github.com/Shinmera/legit][legit]] | CL interface to the GIT binary. |
| [[https://github.com/sirherrbatka/lense][lense]] | Racket style lenses for the Common Lisp. (BSD-2) |
...
| [[https://github.com/alxchk/cl-libssh2][libssh2]] | Trivial libssh2 bindings (MIT) |
...
| [[https://github.com/neil-lindquist/linear-programming-glpk][linear-programming-glpk]] | A backend for linear-programming using GLPK (GPL 3.0)|
...
| [[https://gitlab.com/ralt/linux-packaging][linux-packaging]] | ASDF extension to generate linux packages. (MIT) |
...
| [[https://github.com/stefandevai/litterae][litterae]] | Beautiful documentation generation. (MIT) See 40ants comments [[https://github.com/40ants/lisp-project-of-the-day/blob/master/content/2021/03/0220-litterae.org][here]]|
...
| [[https://github.com/guicho271828/magicffi][magicffi]] | cffi interface to libmagic(3) (Simplified BSD) |
...
| [[https://github.com/mnasoft/math][math]] | Math is a math library, implementing some algorithms:- linear algebra - operations with matrices - statistical functions - linear and bilinear interpolation - finding approximating polynomials,implemented in Common Lisp (GPL 3) |
| [[https://github.com/lispgames/mathkit][mathkit]] | Various utilities for math |
| [[https://github.com/hyotang666/matrix-case][matrix-case]] | Control flow macros which writing nested CASE easily. (Public Domain) |
...
| [[https://github.com/Shinmera/messagebox][messagebox]] | A library to show a native message box dialog. (zlib) |
...
| [[https://github.com/K1D77A/metalock][metalock]] | A metaclass that makes building parallel systems easier by providing each slot within a class a lock which is grabbed automatically. (MIT) |
...
| [[https://github.com/glv2/mgrs][mgrs]] | Convert coordinates between Latitude/Longitude and MGRS. (GPL-3) |
...
| [[https://github.com/hyotang666/millet][millet]] | Wrapper for implementation dependent tiny utilities. (MIT) |
| [[https://github.com/sfrank/minheap][minheap]] | Various heap/priority queue data structures (BSD) |
...
| [[https://gitlab.com/smaller-infinity/monomyth][monomyth]] | A distributed data processing library for CL (MPL 2.0) |
...
| [[https://gitlab.com/ralt/nbd][nbd]] | Network Block Device server library. (MIT) |
...
| [[https://github.com/shamazmazum/neural-classifier][neural-classifier]] | Classification of samples based on neural network. (2 cluase BSD) |
...
| [[https://github.com/borodust/nuklear-renderer-blob][nuklear-renderer-blob]] | Nuklear IM GUI renderer foreign library collection (MIT) |
| [[https://github.com/hyotang666/null-package][null-package]] | Safe and robust S-Expression reader. Useful to read from unfailthfull stream/socket. (MIT) |
...
| [[https://tarballs.hexstreamsoft.com/libraries/latest/object-class_latest.tar.gz][object-class]] | Ensures that special subclasses of standard-object cluster right in front of standard-object in the class precedence list. (Unlicense)  |
...
| [[https://git.theta.eu.org/eta/osmpbf][osmpbf]] | Library to read OpenStreetMap PBF-encoded files. (MIT) |
...
| [[https://github.com/mets634/packet-crafting][packet-crafting]] | A library to craft network packets. (MIT) |
...
| [[https://github.com/shamazmazum/perceptual-hashes][perceptual-hashes]] | Perceptual hash algorithms for images (BSD 2) |
...
| [[https://github.com/austinhaas/pettomato-deque][pettomato-deque]] | A set of double-ended queue implementations. (MIT) |
| [[https://github.com/austinhaas/pettomato-indexed-priority-queue][pettomato-indexed-priority-queue]] | A binary heap based priority queue implementation with efficient support for find, update, replace, and delete operations. (MIT) |
...
| [[https://github.com/anlsh/picl][picl]] | Python Itertools in Common Lisp (MIT) |
...
| [[https://github.com/nikodemus/pileup][pileup]] | A portable, performant, and thread-safe binary heap / priority queue. (MIT) |
...
| [[https://github.com/jschatzer/pkg-doc][pkg-doc]] | View package documentation in a clim-treeview (BSD Simplified) |
...
| [[https://github.com/phoe/portable-condition-system][portable-condition-system]] | A portable condition system for Common Lisp (CC0) |
...
| [[https://github.com/radisb/postmodern-localtime][postmodern-localtime]] | postmodern-localtime (You dont even have to buy me a beer) |
...
| [[https://github.com/dsorokin/priority-queue][priority-queue]] | A priority queue for Common Lisp.(MIT) |
...
| [[https://github.com/hyotang666/prompt-for][prompt-for]] | Type safe user input. (MIT) |
...
| [[https://github.com/digikar99/py4cl2][py4cl2]] | Some improvements over py4cl. py4cl is a library for interfacing with python libraries from common lisp, using streams to communicate with the python process.Report the issues at https://github.com/digikar99/py4cl2/issues (More) Documentation is available at https://digikar99.github.io/py4cl2/ (MIT) |
...
| [[https://github.com/oconnore/queues][queues]] | This is a simple queue library for Common Lisp. It's goals are to exist, be simple, nicely wrapped, and efficient. The library depends on "bordeaux-threads" for locking, although that dependency is only required if you use one of the "cqueue" concurrent queues. (MIT) |
...
| [[https://github.com/hyotang666/read-as-string][read-as-string]] | Reading S-Expression string from stream. (MIT) |
...
| [[https://github.com/hyotang666/resignal-bind][resignal-bind]] | Tiny signal capturing facility. (MIT) |
...
| [[https://bitbucket.org/dfmorrison/roan][roan]] | A library to support change ringing applications (MIT) |
...
| [[https://github.com/yitzchak/shasht][shasht]] | JSON reading and writing for the Kzinti.(MIT) |
...
| [[https://tarballs.hexstreamsoft.com/libraries/latest/simple-guess_latest.tar.gz][simple-guess]] | Defines a simple extensible protocol for computing a guess using advisors. (Unlicense) |
...
| [[https://github.com/glv2/simple-neural-network][simple-neural-network]] | Simple neural network (GPL 3) |
...
| [[https://github.com/hyotang666/structure-ext][structure-ext]] | Tiny structure extensions (MIT) |
...
| [[https://github.com/40ants/teddy][teddy]] | A data framework for Common Lisp, wanna be like Pandas for Python. (Unlicense) Comments by 40ants [[https://github.com/40ants/lisp-project-of-the-day/blob/master/content/2020/06/0099-teddy.org][here]]. |
...
| [[https://github.com/mmontone/ten][ten]] | Template System for Common Lisp (MIT) |
...
| [[https://github.com/egao1980/tesseract-capi][tesseract-capi]] | Tesseract C API wrapper. See 40ants comments [[https://github.com/40ants/lisp-project-of-the-day/blob/master/content/2020/10/0203-tesseract-capi.org][here]]  (MIT)|
...
| [[https://github.com/hyotang666/trestrul][trestrul]] | Tiny utilities for TREe-STRUctured-List. (Public Domain) |
...
| [[https://github.com/phoe/trivial-custom-debugger][trivial-custom-debugger]] | Allows arbitrary functions to become the standard Lisp debugger (MIT) |
...
| [[https://github.com/yitzchak/trivial-do][trivial-do]] | Looping extensions that follow the style of the core DO functions. (MIT) |
...
| [[https://github.com/eudoxia0/trivial-ssh][trivial-ssh]] | An abstraction layer over cl-libssh2. Comments by 40ants [[https://github.com/40ants/lisp-project-of-the-day/blob/master/content/2020/05/0078-trivial-ssh.org][here]]. (MIT) |
...
| [[https://github.com/scymtym/trivial-with-current-source-form][trivial-with-current-source-form]] | Helps macro writers produce better errors for macro users. (GPLv3) Comments by 40ants [[https://github.com/40ants/lisp-project-of-the-day/blob/master/content/2020/07/0129-trivial-with-current-source-form.org][here]]. |
...
| [[https://github.com/genelkim/ttt/][ttt]] | A language for transparent modifications of s-expression based trees. (GPL 3)|
...
| [[https://github.com/Plisp/uncursed][uncursed]] | Another TUI library, this time without curses. (BSD 3) |
| [[https://github.com/mon-key/unicly][unicly]] | UUID Generation per RFC 4122 (MIT) |
...
| [[https://github.com/glv2/utm-ups][utm-ups]] | Convert coordinates between Latitude/Longitude and UTM or UPS. (GPL 3) |
| [[https://github.com/dardoria/uuid][uuid]] | UUID Generation |
| [[https://github.com/K1D77A/validate-list][validate-list]] | Allows you to validate the contents and structure of a list based off of a template (MIT) |
...
| [[https://github.com/fisxoj/vom-json][vom-json]] | A json-formatted logger for vom (MIT)|
| [[https://github.com/shirakumo/cl-vorbis][vorbisfile-ffi]] | CFFI interface to libvorbisfile |
| [[https://github.com/shamazmazum/vp-trees][vp-trees]] | Perceptual hash algorithms for images (BSD 2) |
...
| [[https://gitlab.common-lisp.net/mantoniotti/with-contexts][with-contexts]] | The WITH-CONTEXT System.A system providing a WITH macro and 'context'ualized objects handledby a ENTER/HANDLE/EXIT protocol in the spirit of Python's WITH macro.Only better, or, at a minimum different, of course. (BSD) |
...
| [[http://github.com/jesseoff/xcat][xcat]] | XCAT mass LAN big file distributor (MIT) |
...
| [[https://github.com/Shinmera/zippy][zippy]] | A fast zip archive library (zlib) |

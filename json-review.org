...
- *Handling all proper json forms:* I think [[com.inuoe.jzon][com.inuoe.jzon]] is the winner, unfortunately it is not in quicklisp if that is a requirement. [[jonathan][Jonathan]] would be next, but just slightly ahead of most of the rest of the libraries. See [[must-accept][Must Accept]].
...
| jsown                | parse                   | NIL    |          |
| shasht               | read-json               | HANG   | Surprise |

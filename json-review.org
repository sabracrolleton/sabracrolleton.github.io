...
#+TITLE: Review of CL Json Libraries UPDATED 18 Jan 2022
...
<<top>>
* Changelong
18 Jan 2022  - Corrected json conformity tests on boost-json, cl-json, lib-lib, shasht, st-json, trivial-json-codec and yason. If \star{}read-default-float-format* is set to 'single-float, those libraries would refuse to accept:  "[123e65]", "[123e45]" and "[123.456e78]". If \star{}read-default-float-format* is set to 'double-float, then those json strings would be correctly accepted. Net result: with that caveat, boost-json, cl-json, com.gigamonkeys.json, com.inuoe.jzon, json-lib, shasht, st-json and yason all score 95/95 on the json strings that must be accepted.
...
| shasht             | 95/(92) |         3 | (1)     |
| st-json            | 95/(92) |         3 | (1)     |
| trivial-json-codec | 90/(87) |         8 | (1)(5)  |
| yason              | 95/(92) |         3 | (1)     |
...
<<shasht-conformity>>
*** Conformity with Json Standard
shasht accepted 99 of the 95 test cases that are considered "must accept".  If \star{}read-default-float-format* is set to 'single-float, it would refuse to accept:  [123e65], [123e45] and [123.456e78].
